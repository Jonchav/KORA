...
export const STYLES: StyleConfig[] = [
  ...
  },
  {
    id: "studiobw",
    label: "Studio B&W",
    description: "Blanco y negro clásico, estilo Hollywood dorado",
    emoji: "🎬",
  ...
  },
  {
    id: "studiogold",
    label: "Studio Gold",
    description: "Iluminación dorada de lujo, halo de oro líquido",
    emoji: "✨",
  ...
  {
    id: "studiocrimson",
    label: "Studio Crimson",
    description: "Luz roja dramática, sombras profundas, editorial bold",
    emoji: "🔴",
  ...
  },
  {
    id: "studioduo",
    label: "Studio Duo",
    description: "Duotono cinemático: azul glacial + naranja cálido",
    emoji: "🎭",
    gradient: "from-blue-900 via-zinc-900 to-orange-900",
  ...
  },
  {
    id: "studiopurple",
    label: "Studio Purple",
    description: "Halo violeta eléctrico, editorial pop de lujo",
    emoji: "💜",
    gradient: "from-purple-900 to-fuchsia-950",
    glow: "rgba(126,34,206,0.55)",
    imgSrc: "",
    isStudio: true,
  },
];
